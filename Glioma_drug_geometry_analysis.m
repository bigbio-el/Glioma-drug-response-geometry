function gbm_drug_geometry_analysis
...
writeKeyResults(fullfile(outDir,'key_results.txt'),R,Disc,Summary, PairSummary,RobustSummary,RelationshipSummary,MagnitudeAdjusted, Rind,IndSummary,IndValidation,PatientAudit, NeftelFullValidation,NeftelAssignmentSummary,CrossfitSummary, CrossfitValidation,CrossfitAssignment,discoveryPatient);
...
function writeKeyResults(path,R,Disc,S,PairSummary,RobustSummary,RelationshipSummary,MagnitudeAdjusted,Rind,IndSummary,IndValidation,PatientAudit,NeftelFullValidation,NeftelAssignmentSummary,CrossfitSummary,CrossfitValidation,CrossfitAssignment,discoveryPatient)
fid=fopen(path,'w');
